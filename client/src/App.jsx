	...
	return (
		<>
			...
			<main>
				...
				<section className="section split-section" id="education"><div className="section-intro"><p className="eyebrow">03 / Education</p><h2>Learning with purpose.</h2></div><div className="timeline"><div className="timeline-item"><span>Current</span><div><h3>Digital Health Engineering Technology</h3><p>Centennial College · Diploma program</p></div></div><div className="timeline-item"><span>Developing</span><div><h3>Technology foundations</h3><p>Programming, databases, web development, Linux/Unix, and software requirements.</p></div></div><div className="timeline-item"><span>Focus</span><div><h3>Healthcare technology and cybersecurity</h3><p>Exploring how digital health, cybersecurity, and AI can work together to create safer technologies.</p></div></div></div></section>
